...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'Users created: {User.objects.all()}'))
            ...
            self.stdout.write(self.style.SUCCESS(f'Teams created: {Team.objects.all()}'))
            ...
            self.stdout.write(self.style.SUCCESS(f'Activities created: {Activity.objects.all()}'))
            ...
            self.stdout.write(self.style.SUCCESS(f'Leaderboard entries created: {Leaderboard.objects.all()}'))
            ...
            self.stdout.write(self.style.SUCCESS(f'Workouts created: {Workout.objects.all()}'))
